...
##    PKG_MOSEKHOME="~/mosek/6/tools/platform/linux64x86";
##
## If your computer contains the two directories:
##    ~/mosek/6/tools/platform/linux64x86/bin
##    ~/mosek/6/tools/platform/linux64x86/h
## ----------------------------------------------------------------------
##
...
##    ~/mosek/6/tools/platform/linux64x86/bin/libmosek64.so
##
## or
##    ~/mosek/6/tools/platform/linux64x86/bin/libmosek64.dylib
##
